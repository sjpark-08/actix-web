...
pub async fn post_new_course_db(pool: &PgPool, new_course: CreateCourse) -> Result<Course, EzyTutorError> {
    let course_row = sqlx::query_as!(
        Course,
        "INSERT INTO ezy_course_c6 (tutor_id, course_name, course_description, course_duration, course_level,
        course_format, course_language, course_structure, course_price)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)
        returning course_id, tutor_id, course_name, course_description, course_duration, course_level,
